...
const ProductCard = () => {
  return (
    <div>
      ...
      <div className="p-6">
        <h3 className="text-2xl text-gray-800 font-extrabold">The Hotel</h3>
        <div className="mt-6 flex items-center">
          <h3 className="text-xl text-gray-800 font-bold flex-1">$150.90</h3>
          <div className="bg-pink-100 w-12 h-12 flex items-center justify-center rounded-full cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20px" className="fill-pink-600" viewBox="0 0 64 64">
              <path
